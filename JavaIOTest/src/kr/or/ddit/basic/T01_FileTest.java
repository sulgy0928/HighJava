...
public class T01_FileTest {
	public static void main(String[] args) {
		...
		//File file2 = new File("d:\\D_Oter\\test.txt");
		...
		File file5 = new File("d:/D_Ohter/연습용");
		//if(file5.mkdir()) {
			if(file5.mkdirs()) {
			System.out.println(file5.getName() + "만들기 성공!");
		}else {
			System.out.println(file5.getName() + "만들기 실패ㅜㅜ");
		}
		System.out.println();
		...
		if(file6.mkdir()) {
			...
			System.out.println(file6.getName() + "만들기 실패ㅜㅜ");
		}
