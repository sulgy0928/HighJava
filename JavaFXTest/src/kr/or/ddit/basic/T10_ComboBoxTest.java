...
public class T10_ComboBoxTest extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		list.add(new MyFriend("a001", "홍길동", 
				"010-1111-1111", "대전"));
		list.add(new MyFriend("b001", "일지매", 
				"010-2222-2222", "대구"));
		list.add(new MyFriend("c001", "성춘향", 
				"010-3333-3333", "광주"));
		list.add(new MyFriend("d001", "이몽룡", 
				"010-4444-4444", "부산"));
		list.add(new MyFriend("e001", "변학도", 
				"010-5555-5555", "서울"));
		
		ComboBox<MyFriend> combo = new ComboBox<>(list);
		//combo.setItems(list);
