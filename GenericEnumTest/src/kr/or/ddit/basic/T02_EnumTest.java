...
public enum Season{
	...
	//그래서 클래스와 다르게 막 찍어내듯 만들어 쓸 수가 없다.)
	...
	public static void main(String[] args) {
		/*
		 * 열거형에서 사용되는 메서드
		 * 1. name() => 열거형 상수의 이름을 문자열로 반환한ㄷ.
		 * 2. ordinal() => 열거형 상수가 정의된 순서값을 반환한다. (0부터 시작함)
		 * 3. valueOf("열거형 상수 이름"); => 지정된 열거형에서 '열거형 상수 이름'과 
		 * 									일치하는 열거형 상수를 반환한다.
		 */
		...
		//열거형 객체변수에 값 저장하기
		myCity2 = City.서울;
		myCity1 = City.valueOf("서울"); //City enum 에서 '서울' 상수를 가져옴.
